...
<html>
	<head>
		<title>Pizzaria SA - Pizzas Doces</title>	
			...
			<?php
				...
				<img class=thisalign src='images/banner/logo1.png'/><div class=logado-not-adm>
					...
					<div class='space1'>
						...
						<a href="usuario_deslogar.php" class=buttom-deslogar>Deslogar</a>
					</div>
				</div>
			<?php
			}else{
			...
			<div class=pdtlayout>
				<div class=produtos>
					...
					while($result = mysqli_fetch_assoc($resultQuery)){
						...
						if(isset($_SESSION['id']) && $_SESSION['tipo'] == "ADMIN"){
							if($resultBanco[3] == "DOCE"){
								echo "<div class=products>";
								echo "<div class=image><img src='images/pizzas/$resultBanco[6]' class='image-pdt'/></div>";
								echo "<div class=botaopdt><div class=nomepdt>$resultBanco[2]<a class='delete' href='adminPizzasDoces_delete.php?id=$resultBanco[1]'>×</a></div><div class=botaopdt>R$ $resultBanco[4]</div></div></div>";	
							}
						}else{
							if($resultBanco[3] == "DOCE"){
								echo "<div class=products>";
								echo "<div class=image><img src='images/pizzas/$resultBanco[6]' class='image-pdt'/></div>";
								echo "<div class=botaopdt><div class=nomepdt>$resultBanco[2]</div><div class=botaopdt>R$ $resultBanco[4]</div></div></div>";	
							}
						}
					}?>
				</div>
		...
		<div class="footbar">
			...
			<div class='squareenix'>
				<div class='fotenter'>
					...
					<a class='enixsquare'><div class=heightline>ceo@psa.com</div></a><img class=lineheight src='images/banner/mail.png'><br>
				</div>
			</div>	
			<div class='squareenix'>
				<div class='fotenter'>
