			...
			<div class=layout>
				<div class=barra-principal>
					<label class='barbar'>
						...
						Pizzas<a href='cadastroPizzas_form.php' class=button-plus>+</a>
					</label>
				</div>		
				<div id=minhaDiv3>
					<form metdod=POST action=cadastroPizzas_form.php id=pizzas>
						<?php
						echo "
						...
						while($result = mysql_fetch_assoc($resultQuery)){
							...
							echo "</td>";
							echo "<td>";
							echo "<img src='images/pizzas/$resultBanco[6]' class='squad-fir'>";
							echo "</td>";
							echo "<td>
							<div class=align>
								<a class='edit' href='cadastroPizzas_form.php?id=$resultBanco[1]'>Editar</a>
								<a class='delete' href='adminPizzas_delete.php?id=$resultBanco[1]'>Deletar</a>
							</div></td>";	
							echo "</tr>";
						}?>
						</table>
