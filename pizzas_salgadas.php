...
<html>
	<head>
		<title>Pizzaria SA - Pizzas Salgadas</title>	
		...
		<div>
			...
			<div class=pdtlayout>
				...
				while($result = mysql_fetch_assoc($resultQuery)){
					...
					if(isset($_SESSION['id']) && $_SESSION['tipo'] == "ADMIN"){
						if($resultBanco[3] == "SALGADA"){
							echo "<div class=products>";
							echo "<div class=image><img src='images/pizzas/$resultBanco[6]' class='image-pdt'/></div>";
							echo "<div class=botaopdt><div class=nomepdt>$resultBanco[2]<a class='delete' href='adminPizzasSalgadas_delete.php?id=$resultBanco[1]'>×</a><div class=botaopdt>R$ $resultBanco[4]</div></div></div></div>";	
						}
					}else{
						if($resultBanco[3] == "SALGADA"){
							echo "<div class=products>";
